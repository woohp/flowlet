...
class Flow[T, U = T]:
    ...
    def map[V](
        ...
        *,
        ...
        return self | Flow._from_operator(functional.map(fn, concurrency=concurrency, preserve_order=preserve_order))
    ...
    def flat_map[V](
        ...
        *,
        ...
        return self | Flow._from_operator(
            functional.flat_map(fn, concurrency=concurrency, preserve_order=preserve_order)
        )
    ...
    def filter(
        ...
        *,
        ...
        return self | Flow._from_operator(
            functional.filter(pred, concurrency=concurrency, preserve_order=preserve_order)
        )
